...
export const SEED_CONNECTORS: Connector[] = [
  ...
  },
  {
    ...
    category: 'CRM',
    iconUrl: '/connectors/hubspot.svg',
    authType: 'api_key',
    isActive: true,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    category: 'CRM',
    iconUrl: '/connectors/salesforce.svg',
    authType: 'oauth',
  ...
  },
  {
    ...
    category: 'Support',
    iconUrl: '/connectors/zendesk.svg',
    authType: 'api_key',
    isActive: true,
    createdAt: new Date().toISOString(),
  },
  {
    ...
    category: 'E-commerce',
    iconUrl: '/connectors/shopify.svg',
    authType: 'api_key',
    isActive: true,
    createdAt: new Date().toISOString(),
  },
...
export const CONNECTOR_CATEGORIES = [
  ...
  { slug: 'support', name: 'Support', icon: 'Headphones' },
